    ...
    <main className="min-h-screen flex flex-col bg-background">
      ...
      <section className="flex-1 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        <div className="mb-12 print:hidden">
          <h1 className="text-4xl font-semibold text-foreground mb-2">{t('analysis.title')}</h1>
          <p className="text-foreground/60">{t('analysis.subtitle')}</p>
        </div>
...
export default function AnalysisPage() {
  ...
  return (
    <AuthGate
      doctorOnly
      headline={t('gate.analysisHeadline')}
      message={t('gate.analysisMessage')}
    >
      {(doctor) => (
